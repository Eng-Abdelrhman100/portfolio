...
import NoSSR from "@/components/NoSSR"; // Import the NoSSR component
...
export const BentoGridItem = ({
  ...
  // Move animationData import inside useEffect to avoid SSR issues
  ...
  return (
    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        {/* Background animation - wrapped in NoSSR */}
        {id === 6 && (
          <NoSSR>
        ...
        >
          ...
          {/* Copy email section - wrapped in NoSSR */}
          {id === 6 && (
            <NoSSR>
